...
let private faces = [ Two; Three; Four; Five; Six; Seven; Eight; Nine; Ten; Jack; Queen; King; Ace ]
let deck = [
...
let rec isSameSuit hand = 
    match hand with
    | [] -> true
    | [_] -> true
    | Card (suit1, _) :: Card (suit2, _) :: _ ->
        if suit1 <> suit2 then false
        else isSameSuit (List.tail hand)

(* alternativ løsning, finnes sikkert mange andre måter også
let isSameSuit hand = 
    hand
